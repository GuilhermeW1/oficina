 ...
 * @author Guilherme.w1
 */
public class RelatorioUsuaruios extends javax.swing.JFrame {

    /**
     * Creates new form RelatorioUsuaruios
     */
    public RelatorioUsuaruios() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Buscar Relatorio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioUsuaruios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelatorioUsuaruios().setVisible(true);
            }
        });
    }
